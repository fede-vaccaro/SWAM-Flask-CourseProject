...
from .controllers import AuthenticationAPI, UsersAPI, UserAPI, TicketsAPI, TicketAPI, DebtsAPI, DebtAPI, CreditsAPI, CreditAPI, PayDebtAPI, CreditPaidAPI, PayAllDebtsAPI
